...
@SfChannelConfig
@Data
public class XiaomiChannelConfig extends ChannelConfig {

  @ConfigField(cname = "Android 项目 AppSecret", desc = "平台 Android 类型应用 AppSecret，可在平台配置页面获取")
  @NotBlank
  private String androidAppSecret;

  @ConfigField(cname = "iOS 项目 AppSecret", desc = "平台 iOS 类型应用 AppSecret，可在平台配置页面获取")
  @NotBlank
